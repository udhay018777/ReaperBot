...
async def set_group_photo(gpic):
    ...
    if not gpic.is_group:
        await gpic.edit("This is not a group nigga")
        return
...
async def promote(promt):
    ...
    try:
        ...
        await promt.edit("Promoted Successfully! Party de ab randi!")
...
async def demote(dmod):
    ...
    # Assume we don't have permission to demote
        ...
        return
    await dmod.edit("`Demoted this randi Successfully!`")
...
async def ban(bon):
    ...
    await bon.edit("`Punishing the gey`")
    ...
    if reason:
        await bon.edit(f"Gey `{str(user.id)}` was banned !!\nReason: {reason}")
    else:
