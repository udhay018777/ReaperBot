...
async def startmute(event):
    ...
    if event.fwd_from:
        ...
        private = True
    if any([x in event.raw_text for x in ( "amute", "bmute", "cmute", "dmute", "emute", "fmute", "hmute", "imute", "jmute", "kmute", "lmute", "mmute", "nmute", "omute", "pmute", "qmute", "rmute", "smute", "tmute", "umute", "vmute", "wmute", "xmute", "ymute", "zmute" )]):
...
async def endmute(event):
    ...
    if event.fwd_from:
        ...
        await asyncio.sleep(3)
        private = True
    if any([x in event.raw_text for x in ( "aunmute", "bunmute", "cunmute", "dunmute", "eunmute", "funmute", "gunmute", "hunmute", "iunmute", "junmute", "kunmute", "lunmute", "munmute", "nunmute", "ounmute", "punmute", "qunmute", "runmute", "sunmute", "tunmute", "uunmute", "vunmute", "wunmute", "xunmute", "yunmute", "zunmute" )]):
        await asyncio.sleep(0.5)
    else:
        reply = await event.get_reply_message()
        if event.pattern_match.group(1) is not None:
